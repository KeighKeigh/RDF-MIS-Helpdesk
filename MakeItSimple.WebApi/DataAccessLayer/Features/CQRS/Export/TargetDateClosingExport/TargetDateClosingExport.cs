...
namespace MakeItSimple.WebApi.DataAccessLayer.Features.CQRS.Export.TargetDateClosingExport
{
    public class TargetDateClosingExport
    {
        public class TargetDateClosingExportCommand : IRequest<Unit>
        {
        ...
        public record class TargetDateClosingExportResult
        {
            public Guid? UserId { get; set; }
        ...
        public class Handler : IRequestHandler<TargetDateClosingExportCommand, Unit>
        {
            ...
            public async Task<Unit> Handle(TargetDateClosingExportCommand request, CancellationToken cancellationToken)
            {
                ...
                var closing = await _context.ClosingTickets
                    ...
                    .Select(x => new TargetDateClosingExportResult
                    {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    workbook.SaveAs($"TargetDateClosingReport {request.Date_From:MM-dd-yyyy} - {request.Date_To:MM-dd-yyyy}.xlsx");
