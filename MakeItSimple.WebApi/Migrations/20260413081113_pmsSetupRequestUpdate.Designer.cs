...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20260413081113_pmsSetupRequestUpdate")]
    partial class pmsSetupRequestUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwo", b =>
                {
                    ...
                    b.Property<int?>("OneChargingId")
                        .HasColumnType("int")
                        .HasColumnName("one_charging_id");
                    ...
                    b.HasIndex("OneChargingId")
                        .HasDatabaseName("ix_pmss_one_charging_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwo", b =>
                {
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.OneCharging.OneChargingMIS", "OneCharging")
                        .WithMany()
                        .HasForeignKey("OneChargingId")
                        .HasConstraintName("fk_pmss_one_chargings_one_charging_id");
