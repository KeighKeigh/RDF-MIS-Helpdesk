...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20260416014337_pmsupdate416")]
    partial class pmsupdate416
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("PmsPhaseTwoSectionId")
                        .HasColumnType("int")
                        .HasColumnName("pms_phase_two_section_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pms_questions");

                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_pms_questions_added_by");

                    b.HasIndex("PmsPhaseTwoSectionId")
                        .HasDatabaseName("ix_pms_questions_pms_phase_two_section_id");

                    b.HasIndex("PmsTypeId")
                        .HasDatabaseName("ix_pms_questions_pms_type_id");

                    b.ToTable("pms_questions", (string)null);
                });

            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoQuestionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pms_phase_two_question_category");

                    b.ToTable("pms_phase_two_question_category", (string)null);
                });

            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pms_sections");

                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_pms_sections_added_by");

                    b.HasIndex("PmsTypeId")
                        .HasDatabaseName("ix_pms_sections_pms_type_id");

                    b.ToTable("pms_sections", (string)null);
                });

            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSectionQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pms_section_question");

                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_pms_section_question_added_by");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_pms_section_question_category_id");

                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_pms_section_question_question_id");

                    b.HasIndex("SectionId")
                        .HasDatabaseName("ix_pms_section_question_section_id");

                    b.ToTable("pms_section_question", (string)null);
                });
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoAnswer", b =>
                {
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSectionQuestion", "SectionQuestion")
                        .WithMany()
                        .HasForeignKey("SectionQuestionID")
                        .HasConstraintName("fk_pms_answers_pms_section_question_section_question_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoQuestion", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_pms_questions_users_added_by_user_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSection", null)
                        .WithMany("PmsQuestion")
                        .HasForeignKey("PmsPhaseTwoSectionId")
                        .HasConstraintName("fk_pms_questions_pms_sections_pms_phase_two_section_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoType", "PmsType")
                        .WithMany("PmsQuestion")
                        .HasForeignKey("PmsTypeId")
                        .HasConstraintName("fk_pms_questions_pms_type_pms_type_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSection", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_pms_sections_users_added_by_user_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoType", "PmsType")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_pms_sections_pms_type_pms_type_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSectionQuestion", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_pms_section_question_users_added_by_user_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoQuestionCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pms_section_question_pms_phase_two_question_category_category_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoQuestion", "Question")
                        .WithMany("SectionQuestions")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pms_section_question_pms_questions_question_id");

                    b.HasOne("MakeItSimple.WebApi.Models.Phase_Two.PMS.PmsPhaseTwoSection", "Section")
                        .WithMany()
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pms_section_question_pms_sections_section_id");
